...
public class SuperB_EVENT_GUI implements ActionListener {
    //Initialising GUI placeholders in code
    JFrame C_Frame = new JFrame("SuperB Event Calculator");
    ...
    public static void main(String[] args) {
        SuperB_EVENT_GUI calc = new SuperB_EVENT_GUI();
    }
